...
void CEDROOMSystemCommSAP::RegisterInterfaces(){
	...
	m_localCommSAP.RegisterInterface(1, mp_comp6->GuidanceCtrl, mp_comp6);
	m_localCommSAP.RegisterInterface(2, mp_comp6->GuidanceTimer, mp_comp6);
...
void CEDROOMSystemCommSAP::SetLocalConnections(){
	...
	m_localCommSAP.Connect(mp_comp2->GuidanceCtrl, mp_comp6->GuidanceCtrl, connections[0], 
