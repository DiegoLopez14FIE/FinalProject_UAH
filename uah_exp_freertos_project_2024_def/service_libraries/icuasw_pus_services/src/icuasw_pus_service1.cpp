...
#define TM_1_8_TC_129_1_SPEED_NOT_VALID  		13
#define TM_1_8_TC_129_2_CONSTANT_NOT_VALID  	14
...
void PUSService1::BuildTM_1_8_TC_129_1_SpeedNotValid(CDTCHandler &tcHandler,
		CDTMList &tmList) {
	...
	tmHandler.SetUInt16AppDataField(tcHandler.GetPacketID());
	tmHandler.SetUInt16AppDataField(tcHandler.GetPackSeqCtrl());
	tmHandler.SetUInt8AppDataField(TM_1_8_TC_129_1_SPEED_NOT_VALID);
	tmList.AddTM(tmHandler.CloseTM());

}

void PUSService1::BuildTM_1_8_TC_129_2_ConstantNotValid(CDTCHandler &tcHandler,
		CDTMList &tmList) {
	...
	tmHandler.SetUInt16AppDataField(tcHandler.GetPacketID());
	tmHandler.SetUInt16AppDataField(tcHandler.GetPackSeqCtrl());
	tmHandler.SetUInt8AppDataField(TM_1_8_TC_129_2_CONSTANT_NOT_VALID );
