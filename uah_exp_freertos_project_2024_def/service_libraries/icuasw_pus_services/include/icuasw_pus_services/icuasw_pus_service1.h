...
public:
  ...
  static void BuildTM_1_8_TC_129_1_SpeedNotValid(CDTCHandler &tcHandler,CDTMList &tmList);
  static void BuildTM_1_8_TC_129_2_ConstantNotValid(CDTCHandler &tcHandler,CDTMList &tmList);
